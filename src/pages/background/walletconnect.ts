...
async function init() {
  ...
  popupMessenger.reply('disconnect-wallet', async ({ session }: { session: SessionTypes.Struct }) => {
  ...
  // disconnect WC app
  popupMessenger.reply('disconnect-app', async ({ session }: { session: SessionTypes.Struct }) => {
